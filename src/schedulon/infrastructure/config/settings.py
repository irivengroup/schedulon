...
class Settings(BaseSettings):
    ...
    ldap_allowed_groups: str | None = None
    ldap_admin_group: str | None = None
    ldap_operator_group: str | None = None
    ldap_viewer_group: str | None = None
    ldap_approver_group: str | None = None
    ...
    model_config = SettingsConfigDict(env_prefix="SCHEDULON_", env_file=".env", extra="ignore", frozen=True)
